...
#SBATCH --output=/home/ruism/projects/def-rsdjjana/ruism/Dreamer_v2_SDH/results/reacherloca_v2_rep_norm_state_dist/%A-%a.out
#SBATCH --error=/home/ruism/projects/def-rsdjjana/ruism/Dreamer_v2_SDH/results/reacherloca_v2_rep_norm_state_dist/%A-%a.err

set -e -o pipefail

# Top-level results dir on Lustre
BASE_SAVE_DIR="$HOME/projects/def-rsdjjana/ruism/Dreamer_v2_SDH/results/reacherloca_v2_rep_norm_state_dist"
...
RUN_DIR="${SLURM_TMPDIR}/dreamer-v2-sdh-r-rep-norm-${SLURM_JOB_ID:-0}-${SEED}"
